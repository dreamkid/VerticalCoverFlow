package com.hezd.multicoverflow.widget;
...
public class VerticalCoverFlowView extends RelativeLayout {
    ...
    public VerticalCoverFlowView(Context context) {
        super(context);
        init();
    }

    public VerticalCoverFlowView(Context context, AttributeSet attrs) {
        super(context, attrs);
        initAttributes(context, attrs);
        init();
    }

    public VerticalCoverFlowView(Context context, AttributeSet attrs, int defStyle) {
